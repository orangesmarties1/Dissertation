...
if __name__ == "__main__":
    ...
    read_words("imdb-all-sentences-pos.txt", words)
    read_words("imdb-all-sentences-neg.txt", words)
    ...
    # changed stopwords.txt to stop_words.py
    with open("stop_words.py") as file:
        for word in file:
