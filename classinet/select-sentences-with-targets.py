...
if __name__ == "__main__":
    ...
    pos_yes_sentences, pos_no_sentences = select_sentences("imdb-all-sentences-pos.txt", words)
    neg_yes_sentences, neg_no_sentences = select_sentences("imdb-all-sentences-neg.txt", words)
